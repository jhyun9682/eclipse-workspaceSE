...
public class ReferenceTypeArrayAccountMain {
	...
	public static void main(String[] args) {
		...
		Account[] accounts = { acc1, new Account(2222, "LEE", 58900, 0.5), new Account(3333, "PARK", 78000, 0.4),
				...
				new Account(6666, "HONG", 99000, 1.4), new Account(7777, "SONG", 87600, 0.6),
		...
		/********************
		 * OPTION*********************** 1. accounts배열 객체에 새로생성한계좌객체 추가 2. accounts배열
		 * 객체에서 계좌번호 4444번계좌객체삭제
		 */
