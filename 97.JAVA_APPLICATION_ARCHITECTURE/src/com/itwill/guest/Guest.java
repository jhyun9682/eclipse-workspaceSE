...
public class Guest {
	...
	public Guest(int guesnt_no, String guest_name, Date guest_date, String guest_email, String guest_homepage,
			String guest_title, String guest_content) {
		super();
		this.guesnt_no = guesnt_no;
	...
	public int getGuesnt_no() {
		return guesnt_no;
	}

	public void setGuesnt_no(int guesnt_no) {
		this.guesnt_no = guesnt_no;
	}
	...
	public String toString() {
		return "Guest [guesnt_no=" + guesnt_no + ", guest_name=" + guest_name + ", guest_date=" + guest_date
